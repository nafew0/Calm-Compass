"""
Django settings for calm_compass project.
...
MIDDLEWARE = [
    ...
    "calm_compass.middleware.ContentSecurityPolicyMiddleware",
]

ROOT_URLCONF = "calm_compass.urls"
...
WSGI_APPLICATION = "calm_compass.wsgi.application"
ASGI_APPLICATION = "calm_compass.asgi.application"
...
if db_engine == "django.db.backends.sqlite3":
    ...
    DATABASES = {
        "default": {
            "ENGINE": db_engine,
            "NAME": os.environ.get("DB_NAME", "calm_compass_db"),
...
AUTH_REFRESH_COOKIE_NAME = os.environ.get("AUTH_REFRESH_COOKIE_NAME", "calm_compass_refresh")
